...
<body>
	...
	try {
		...
		boolean isSysStaff = true;

		//Make an insert statement for the Sells table:
		String insert = "INSERT INTO users(username, ru_email, password, isSysStaff)"
				+ "VALUES (?, ?, ?, ?)";
		...
		if (countUsers==newCount)
			response.sendRedirect("error.jsp?msg=New System Support Staff Registration failed");
		else{
