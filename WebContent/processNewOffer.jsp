...
<body>
	...
	try {
		...
		String str = "SELECT COUNT(*) as cnt FROM offers";
		...
		int countOffers = result.getInt("cnt");
		...
		String insert = "INSERT INTO offers(departure, destination, date, timeFrom, timeTo, isRecurring, driver, car)"
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
		...
		//Check new count
		str = "SELECT COUNT(*) as cnt FROM offers";
